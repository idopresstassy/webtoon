...
`migrations/20260830_pinned_webtoon_comments.sql`을 이어서 실행하면 운영자가 댓글을 상단에 고정·해제할 수 있습니다. 고정 댓글은 비회원·회원 모두에게 일반 댓글보다 먼저 표시되고, 고정·해제 권한은 기존 운영자 전용 댓글 수정 정책을 그대로 사용합니다.
